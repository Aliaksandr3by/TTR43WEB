...
{
    public partial class ATTACHMENTMDFContext : DbContext
    {
        public ATTACHMENTMDFContext()
        {
        }

        public ATTACHMENTMDFContext(DbContextOptions<ATTACHMENTMDFContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TableHead> TableHead { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TableHead>(entity =>
            {
                entity.Property(e => e.Id).ValueGeneratedNever();

                entity.Property(e => e.HeadTeg).HasMaxLength(25);

                entity.Property(e => e.TableName).HasMaxLength(15);
            });
